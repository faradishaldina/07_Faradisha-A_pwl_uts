          ...
          <div class="card">
            ...
            <form action="/updatedata/{{ $data->id }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="kode_barang"class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->kode_barang }}">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <select class="form-select" name="kategori_barang" aria-label="Default select example">
                  <option selected>{{ $data->kategori_barang }}</option>
